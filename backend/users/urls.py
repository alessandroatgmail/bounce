...
from .views import ActivateView, CheckEmailView, CitySearchView, DeactivateView, LoginView, LogoutView, MeView, QRCodeView, RegisterView, UserListView, ws_ticket
