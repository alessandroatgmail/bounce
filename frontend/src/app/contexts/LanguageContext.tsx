...
const translations = {
  it: {
    ...
    'festival.info.multiEventsNote': '(i cambiamenti di stato si propagano solo agli eventi figli)',
  ...
  en: {
    ...
    'festival.info.multiEventsNote': '(status changes cascade to child events only)',
